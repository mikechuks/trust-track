              ...
              <div class="card position-relative">
                <div class="card-body">
                  <div id="detailedReports" class="carousel slide detailed-report-carousel position-static pt-2" data-ride="carousel">
                    ...
                    <?php
                        if($delete_product_records)
                        {
                          $active = ""; 
                            foreach($delete_product_records as $category_List)
                            {
                          ...
                          <div class="col-md-12 col-xl-9">
                            <div class="row">
                              <div class="col-md-6 border-right">
                                ...
                                <div class="img-box">
                                    <img style="min-height: 300px; min-width: 350px; max-height: 500px; max-width: 400px;" src="/uploads/'.$category_List['image'].'" alt="">
                                </div>
                                </div>
                              </div>
                              ...
                              <form method="post">
                              <input type="hidden" name="rand-con-id" value="'.$category_List['rand_pro'].' " />
                                  <button type="submit" class="btn btn-danger btn-lg" formaction="'. base_url('final-delete-product-admin').'">Delete Product</button>
                            </form>
                                </div>
                              </div>
                            </div>
