...
<?= $this->section("body-dashboard") ?>
      <div class="main-panel">
        ...
        <div class="card">
               ...
               <?php endif;?>
                  <input type="hidden" name="pro-id" value="<?= $pro_records['product_id'] ?>" />
                    ...
                    <input type="submit" class="btn btn-primary mr-2" name="update-pro" formaction="<?= base_url('update-product-admin') ?>"/>
                  </form>
                </div>
              </div>
            </div>
